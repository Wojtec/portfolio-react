            ...
            <Row>
              <Col md="4">
                <div className="skill text-center">
                  ...
                  <p className="skill-text">
                    I will create any of your amazing ideas. Fast web
                    applications with animations and fully responsive content.
                  </p>
                </div>
              </Col>
              <Col md="4">
                <div className="skill text-center">
                  ...
                  <p className="skill-text">
                    REST APIs are fast, efficient and secure built following
                    best practices. Using technology like Node.js and
                    Express.js.
                  </p>
                </div>
              </Col>
              <Col md="4">
                <div className="skill text-center">
                  ...
                  <p className="skill-text">
                    Third-party API integration of any provider, dependent on
            ...
            <Row>
              ...
              <Col md="4">
                <div className="skill text-center">
                  ...
                  <p className="skill-text">
                    Relational and Non-Relational Database design for Web
                    development, built with MySQL or MongoDB.
                  </p>
                </div>
              </Col>
              <Col md="4">
                <div className="skill text-center">
                  ...
                  <p className="skill-text">
                    Cloud integration on platform Amazon Web Services with
